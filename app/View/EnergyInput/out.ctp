...
<div class="btn_pdf"><p><a href="<?php echo $this->Html->url(array("controller" => "energy_input", "action" =>"pdf/out")); ?>" onclick="return confirm(&#39;<?php echo __('PDFファイルをダウンロードします'); ?>&#39;)"><?php echo __('出力'); ?></a></p></div>
<div class="clr"></div>
...
<td style="text-align:center">MJ/t</td>
</tr>
<tr class="off">
...
<td class="name"><?php echo __('炉出口排ガス温度'); ?></td>
<?php 
	if(isset($EnergyInput['IND1']) && $EnergyInput['IND1'] != 1 && isset($EnergyInput['Q5']) && $EnergyInput['Q5']==1){
		echo '<td>';
...
<?php echo $this->Form->create('energy_input', array(
		'id' => 'EnergyInputForm',
		'type' => 'post',
		'url' => array('controller' => 'energy_input', 'action' => 'out'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
