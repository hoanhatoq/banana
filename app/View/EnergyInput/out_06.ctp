...
<div class="btn_pdf"><p><a href="<?php echo $this->Html->url(array("controller" => "energy_input", "action" =>"pdf/out_06")); ?>" onclick="return confirm('<?php echo __('PDFファイルをダウンロードします'); ?>')"><?php echo __('出力'); ?></a></p></div>
...
<?php echo $this->Form->create('energy_input', array(
		'id' => 'EnergyInputForm',
		'type' => 'post',
		'url' => array('controller' => 'energy_input', 'action' => 'out_06'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
...
<div class="btn_ok"><p><a href="#" onClick="submit_frm_po_06();"><?php echo __('次へ'); ?></a></p></div>
