...
<?php echo $this->Form->create('innovation_input', array(
		'id' => 'InnovationInputForm',
		'type' => 'post',
		'url' => array('controller' => 'innovation_input', 'action' => 'page_b19'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
...
<?php $vIjig = (isset($InnovationInput['page_b19']['Ijig'][$act])) ? $InnovationInput['page_b19']['Ijig'][$act] : '';	
...
<div id="btn_ok" class="btn_ok"><p><a href="#" onclick="submit_frm_b19();"><?php echo __('OK'); ?></a></p></div>
</div>
...
function submit_frm_b19(){
	...
	$.ajax({
		url: "<?php echo $this->webroot, $this->params['controller']; ?>/page_b19",
		type: "POST",
		cache: false,
		data: $("#InnovationInputForm").serialize(),
		success: function(responce){
			var sel = $('input[class=Ijig]:checked', '#InnovationInputForm').val();
