...
<?php 
	echo $this->Form->create('innovation_input', array(
		...
		'type' => 'post',
		'url' => array('controller' => 'innovation_input', 'action' => 'page_b04'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
...
<td>
	<?php $vEl_wall2 = 	isset($InnovationInput['page_b04']['El_wall2']) ? 
						$InnovationInput['page_b04']['El_wall2']: '';
...
<td>
	<?php $vEl_opening2 = 	isset($InnovationInput['page_b04']['El_opening2']) ? 
							$InnovationInput['page_b04']['El_opening2']: '';
...
<td>
	<?php $vEl_cw2 = 	isset($InnovationInput['page_b04']['El_cw2']) ? 
						$InnovationInput['page_b04']['El_cw2']: '';
...
<td>
	<?php $vEl_storage2 = 	isset($InnovationInput['page_b04']['El_storage2']) ? 
							$InnovationInput['page_b04']['El_storage2']: '';
...
<div class="btn_ok"><p><a href="#" onClick="submit_form_b04();"><?php echo __('OK'); ?></a></p></div>
...
<script type="text/javascript"> 
	function submit_form_b04(){		
		...
		$.ajax({
			url: "<?php echo $this->webroot, $this->params['controller']; ?>/page_b04",
			type: "POST",
			cache: false,
			...
			success: function(responce){
				...
				$("#Eh_fuel_b04", opener.document).html(resp.Eh_fuel);
				$("#Eh_fuel2_b04", opener.document).val(resp.Eh_fuel2);
				$("#Save_energy_ratio_b04", opener.document).val(resp.Save_energy_ratio);
