...
<?php 
	echo $this->Form->create('innovation_input', array(
		...
		'type' => 'post',
		'url' => array('controller' => 'innovation_input', 'action' => 'page_b13'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
...
<td><p class="cul5"><a id="actp13" href="javascript:w=window.open('<?php echo $this->Html->url(array("controller" => "innovation_input", "action" =>"page_b19/13")); ?>','','scrollbars=yes,Width=630,Height=560');w.focus();"><?php echo __('選択'); ?></a></p>
	<?php $vIjig13 = (isset($InnovationInput['Ijig'][13]))? $InnovationInput['Ijig'][13] : '';
		echo $this->Form->input('Ijig[13]',
		array(
			'id' => 'Ijigp13',
			'name' => 'data[innovation_input][Ijig][13]',
			'type' => 'text',			
			'value' => $vIjig13,
			'class' => 'medium select',
			'hidden' => true,
...
$vIjig_name13 = (isset($InnovationInput['page_b13']['Ijig_name'][13]))? 
				$InnovationInput['page_b13']['Ijig_name'][13] : '';
		echo $this->Form->input('Ijig_name[13]',
		array(
			'id' => 'Ijig_namep13',
			'name' => 'data[innovation_input][Ijig_name][13]',
			'type' => 'text',	
			'readonly' => true,		
			'value' => $vIjig_name13,
			'class' => 'medium select',
...
<td>
	<?php $vMj2 = 	isset($InnovationInput['page_b13']['Mj2']) ? $InnovationInput['page_b13']['Mj2']: '';
...
<td>
	<?php $vTj12 = 	isset($InnovationInput['page_b13']['Tj12']) ? 
					$InnovationInput['page_b13']['Tj12']: '';
...
<td>
	<?php $vTj22 = 	isset($InnovationInput['page_b13']['Tj22']) ? 
					$InnovationInput['page_b13']['Tj22']: '';
...
<div class="btn_ok"><p><a href="#" onClick="submit_form_b13();"><?php echo __('OK'); ?></a></p></div>
...
<script type="text/javascript"> 
	function submit_form_b13(){	
		var msg_error = "";
		var id_err = [];
		var check = true;

		if($("#Ijig_namep13").val().length === 0) {				
			msg_error += "<?php echo __('ジグ材料を選択してください');?>\n";
			id_err.push("Ijig_namep13");
			check = false;	
		}
		...
		$.ajax({
			url: "<?php echo $this->webroot, $this->params['controller']; ?>/page_b13",
			type: "POST",
			cache: false,
			...
			success: function(responce){
				...
				$("#EF1_b13", opener.document).html(resp.EF1);
				$("#EF2_b13", opener.document).val(resp.EF2);
				$("#Save_energy_ratio_b13", opener.document).val(resp.Save_energy_ratio);
