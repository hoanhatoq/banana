...
<?php 
	echo $this->Form->create('innovation_input', array(
		...
		'type' => 'post',
		'url' => array('controller' => 'innovation_input', 'action' => 'page_b14'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
...
<tr>
<th><label for="2"><?php echo __('入口温度'); ?></label></th>
<td>
	<?php
...
<td>
	<?php $vTp12 = 	isset($InnovationInput['page_b14']['Tp12']) ? 
					$InnovationInput['page_b14']['Tp12']: '';
...
<tr>
<th><label for="3"><?php echo __('出口温度'); ?></label></th>
<td>
	<?php
...
<td>
	<?php $vTp22 = 	isset($InnovationInput['page_b14']['Tp22']) ? 
					$InnovationInput['page_b14']['Tp22']: '';
...
<tr>
<th><label for="4"><?php echo __('材料搬送量'); ?></label></th>
<td>
	<?php
...
<td>
	<?php $vMloss2 = 	isset($InnovationInput['page_b14']['Mloss2']) ? 
						$InnovationInput['page_b14']['Mloss2']: '';
...
<tr>
<th><label for="5"><?php echo __('材料必要量'); ?></label></th>
<td>
	<?php
		echo $InnovationInput['Eeffect1'];
	?>
	ｋJ/t
</td>
<td>
	<?php $vEeffect2 = (isset($InnovationInput['page_b14']['Eeffect2']))? 
						$InnovationInput['page_b14']['Eeffect2'] :'';
...
<div class="btn_ok"><p><a href="#" onClick="submit_form_b14();"><?php echo __('OK'); ?></a></p></div>
...
<script type="text/javascript">
	function submit_form_b14(){		
		...
		if(!isNumberic($("#Mloss2").val())){				
			msg_error += "<?php echo __('材料搬送量に数値を入力してください');?>\n";
			id_err.push("Mloss2");
			check = false;	
		}
		...
		$.ajax({
			url: "<?php echo $this->webroot, $this->params['controller']; ?>/page_b14",
			type: "POST",
			cache: false,
			...
			success: function(responce){
				...
				$("#EF1_b14", opener.document).html(resp.EF1);
				$("#EF2_b14", opener.document).val(resp.EF2);
				$("#Save_energy_ratio_b14", opener.document).val(resp.Save_energy_ratio);
