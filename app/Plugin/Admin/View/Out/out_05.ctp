...
<div class="btn_pdf"><p><a><?php echo $this->Html->link(__('出力'), array('controller' =>'out','action' => 'out_05_pdf', $chk['UserResult']['id']),array(),__('PDFファイルをダウンロードします')); ?></a></p></div>
<div class="clr"></div>
...
<?php echo $this->Form->create('out', array(
		'id' => 'OutForm',
		'type' => 'post',
		'url' => array('controller' => 'out', 'action' => 'out_05', $chk['UserResult']['id']),
		'inputDefaults' => array(
        	'label' => true,
        	'div' => true
    	)
