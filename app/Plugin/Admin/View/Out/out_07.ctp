...
<div class="btn_pdf"><p><a><?php echo $this->Html->link(__('出力'), array('controller' =>'out','action' => 'out_07_pdf', $chk['UserResult']['id']),array(),__('PDFファイルをダウンロードします')); ?></a></p></div>
...
<td class="total"><?php echo (isset($EnergyInput['out_07']['Total_in_ratio']))? $EnergyInput['out_07']['Total_in_ratio'] : 0.0 ;?></td>
</tr>
<tr>
...
<td class="total"><?php echo (isset($EnergyInput['out_07']['Total_out_ratio']))? $EnergyInput['out_07']['Total_out_ratio'] : 0.0 ;?></td>
</tr>
</table>
...
<?php echo $this->Form->create('energy_input', array(
		'id' => 'EnergyInputForm',
		'type' => 'post',
		'url' => array('controller' => 'out', 'action' => 'out_07'),
		'inputDefaults' => array(
        	'label' => false,
        	'div' => false
    	)
...
<input type="hidden" name="uid" value="<?php echo $chk['UserResult']['id'];?>" id="uid" class="select">
